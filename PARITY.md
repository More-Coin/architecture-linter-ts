...
1. **Stage 1 refresh — this document.** ✅ Complete (v2 with Swift 0.2.5 numbers, registered vs defined split, repository role-fit added, controllers-usecase decision clarified).
